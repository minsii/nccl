...
std::vector<std::string> NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK;
std::vector<std::string> NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK_DEFAULT;
...
void initEnvSet(std::unordered_set<std::string>& env) {
  ...
  env.insert("NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK");
...
void readCvarEnv() {
  ...
  NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK = env2strlist("NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK", "");
  NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK_DEFAULT.clear();
  NCCL_PROXYTRACE_NET_SEND_FAILURE_MOCK_DEFAULT = env2strlist("NCCL_ENV_DO_NOT_SET", "");
